...
/**
 * Class CloudCalculatorForm.
 *
 * @package Drupal\cloud_calculator\Form
 */
class CloudCalculatorForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['cloud_requirements']['traffic'] = [
      '#type' => 'fieldset',
      '#title' => 'Traffic Stats',
      '#attributes' => [
        'class' => [
    ...
    $form['cloud_requirements']['assumptions'] = [
      '#type' => 'fieldset',
      '#title' => ('Application assumptions'),
      '#attributes' => [
        'class' => [
          'fieldset-no-legend',
        ],
    ...
    $form['cloud_requirements']['requirements'] = [
      '#type' => 'fieldset',
    ...
    $form['cloud_requirements']['requirements']['compliance'] = [
      '#type' => 'checkboxes',
      '#options' => [
        'PCI' => $this->t('PCI'),
        'PII' => $this->t('PII'),
      ...
      '#title' => $this->t('Compliance requirements'),
    ];
    $form['cloud_requirements']['requirements']['addons'] = [
      '#type' => 'checkboxes',
      '#options' => [
      ...
      '#title' => $this->t('Add-on requirements'),
    ];
    ...
    if (!empty($form_state->getValue('results'))) {
      ...
      $pass_link = Link::fromTextAndUrl($this->t('Click Here ?'), Url::fromRoute('cloud_calculator.results'))->toString();
      $form['results']['note'] = [
        '#type' => 'markup',
        '#markup' => $this->t('To view all server specs @link', ['@link' => $pass_link]),
